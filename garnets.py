...
# Implementation of the Garnets as introduced in
# *On the Use of Non-Stationary Strategies for Solving Two-Player Zero-Sum Markov Games*
class Garnets:
    def __init__(self, nb_states, nb_actions, nb_next_state_transition, self_transitions=0):
    ...
    def _find_farther_state(self, gamma):
        ...
        for final_state in range(1, self.nb_states):
            ...
            rl = spibb.spibb(gamma, self.nb_states, self.nb_actions, mask_0, mask_0, p, r_reshaped, 'default', 0, None, None, None)
            rl.fit()
